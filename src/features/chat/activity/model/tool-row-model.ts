import { canonicalToolTrace } from '@/features/chat/tool-model/tool-traces';
import {
...
import { describeMcpActivity } from '@/features/chat/tool-model/mcp-activity-model';
import { describeTraceLine } from '@/features/chat/activity/model/trace-activity-model';
import {
  presentWebSearchAction,
  webSearchRunsByTraceLine,
} from '@/features/chat/tool-model/web-search-model';
